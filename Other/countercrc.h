...
static const QByteArray STX = "\02";
static const QByteArray ETX = "\03";

class CounterCrc {

public:
    QByteArray countCrc(QByteArray sequenceToCount) {
        unsigned char crc16htab[] = {
            ...
            Hi = hi;
            Lo = lo;
            checkSum = "#" + QByteArray::fromStdString(Hi).toHex().toUpper() + QByteArray::fromStdString(Lo).toHex().toUpper();

            return STX + sequenceToCount + checkSum + ETX;
    }
};
